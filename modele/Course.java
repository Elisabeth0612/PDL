...
public class Course {
	...
	public Course(EvenementSportif evt,String nomCourse,int heureDeb, int heureFin, int dureePilotageMaxParPilote, int dureeConsecutivePilotageMaxParPilote, String meteo, int nbToursMax, String typeFin){
		this.evt=evt;
	...
	public void modifierCourse(EvenementSportif evt,String nomCourse,int heureDeb, int heureFin, int dureePilotageMaxParPilote, int dureeConsecutivePilotageMaxParPilote, String meteo, int nbToursMax, String typeFin){
		setEvt(evt);
